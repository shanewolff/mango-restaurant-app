...
const App = (props) => {
	...
	return (
		<Container>
			...
			{content === 'product-view' && (<ProductView onContentChange={handleContentChange} products={products} onEditClick={handleProductEditing} totalStockLevel={totalStockLevel} />)}
